%% @doc `mcl-turn-credentials/info', the procedure mcl_om 0.28 answers for this service with
...
-module(mcl_turn_credentials_info_tests).

-include_lib("eunit/include/eunit.hrl").

-define(SERVICE, mcl_turn_credentials_service).
-define(ORG, <<"mcl-turn-credentials">>).
